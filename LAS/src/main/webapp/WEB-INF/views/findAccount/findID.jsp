...
<!-- 				<input type="radio" name="AuthWay" checked="checked" value="email"><label>이메일</label> -->
					<form action="/namebirthcheck" id="fm" method="post">
						<div class="box-inner cf" id="email-inner">
							<dl>
								<dt><label>이름</label></dt>
								<dd><input type="text" name="name" id="name" maxlength="6" placeholder="가입자의 본명을 입력하세요." required></dd>
								<dt><label>생년월일</label></dt>
								<dd><input type="text" name="birth" id="birth" maxlength="8" placeholder="생년월일 8자리 입력하세요.(ex: 19960203)" required>
								<!-- <a href="#" id="emailAuth_btn">인증번호 받기</a> --></dd>
								<!-- <dt><label>인증번호</label></dt>
								<dd><input type="text" disabled name="emailAuth" id="emailAuth" maxlength="8"> 
								<span id="emailAuthTimer"></span></dd> -->
							</dl>
						</div>
					</form>
				</div>
