...
<div id="wrap">
    ...
    <header id="header">
        <div class="inner-wrap">
            <div class="arr">
                <i class="fa fa-angle-left" aria-hidden="true" onclick="javascript:location.href='/prototype/account_edit_editform';"></i>
            </div>
        ...
        <div id="contents">
            ...
            <div class="vc-box">
                <div class="inner-wrap">
                    ...
                    <form action="/prototype/passwordResetProcess" method="post" id="form-resetPW">
